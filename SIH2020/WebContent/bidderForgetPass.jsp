...
<!--Main starts from here-->
			<div class="jumbotron" style="width: 50%; margin-left: 500px;">
                ...
                <hr class="my-4">
                <p class="lead">
                  <form method="POST" action="bidderForgetPass2.jsp">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm">
                          ...
                          <div class="col-sm">
                            <div class="form-group">
                               ...
                               <input type="password" class="form-control" name="bnewCpass" id="exampleInputClg1"  aria-describedby="colHelp" placeholder="Re-enter" required>
                               <!-- <small id="emailHelp" class="form-text text-muted">Format ---- ---- ----</small> -->
                        </div>
                     </div>
                     </div>
