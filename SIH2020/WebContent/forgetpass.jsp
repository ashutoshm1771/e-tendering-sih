...
<!--Main starts from here-->
			<div class="jumbotron" style="width: 50%; margin-left: 500px;">
                <h1 class="display-4">Enter New Password</h1>
                        ...
                        <div class="row">
                            <div class="col-sm">
                                 <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="newpass" id="exampleInputClg1"  aria-describedby="colHelp" placeholder="New Password" required>
                                    <!-- <small id="emailHelp" class="form-text text-muted">Format ---- ---- ----</small> -->
                             </div>
                          </div>
                          <div class="col-sm">
                            <div class="form-group">
                               <label for="exampleInputPoy1">Re-enter Your New Password</label>
                               <input type="password" class="form-control" name="newcpass" id="exampleInputClg1"  aria-describedby="colHelp" placeholder="Re-enter" required>
                               <!-- <small id="emailHelp" class="form-text text-muted">Format ---- ---- ----</small> -->
                        </div>
                     </div>
                     </div>
