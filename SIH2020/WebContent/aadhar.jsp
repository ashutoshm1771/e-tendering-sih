...
<!--Main starts from here-->
			<div class="jumbotron" style="width: 50%; margin-left: 500px;">
                <h1 class="display-4">Aadhar Number</h1>
                <p class="lead">Aadhar number verification.</p>
                <hr class="my-4">
                <p class="lead">
                        ...
                        <div class="row">
                            <div class="col-sm">
                                 <div class="form-group">
                                    <label for="exampleInputPoy1">Enter Your Aadhar number</label>
                                    <input type="text" class="form-control" name="torg" id="exampleInputClg1"  aria-describedby="colHelp" placeholder="12 Digit Number" required>
