...
<!--Main starts from here-->	
		<main>
      <div class="jumbotron">
      <h1 class="display-4" id="header" align="center">Bidder Registration</h1><br>
      <hr class="my-4">
                  ...
                  <div class="row">
                      <div class="col-sm">
                           <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="bisdcode" id="exampleInputPoy1"  aria-describedby="poyHelp"  placeholder="Phone ISD Code" required>
                  ...
                  <div class="row">
                    <div class="col-sm">
                             <div class="form-group">
                                   ...
                                   <input type="email" class="form-control" name="bemail" id="exampleInputmail1" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" aria-describedby="mailHelp"  placeholder="Eg : johndoe@gmail.com" required>
                                   <!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
                            </div>
                     </div>
                     <div class="col-sm">
