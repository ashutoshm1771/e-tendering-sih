...
<!--Main starts from here-->	
	<main>
        <%
            ...
            String location=request.getParameter("sdept");
            Statement st = con.createStatement();
			ResultSet rs;
			rs = st.executeQuery(" select * from  tenderdetails  where classification=\""+request.getParameter("sdept")+"\"");
        %>
			<div class="jumbotron">
			    <h1 class="display-4">Tenders By Given Class</h1>
                <div class="card">
