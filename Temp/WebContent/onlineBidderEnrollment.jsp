						...
						<div class="row">
							<div class="col-sm">
									<div class="form-group">
										...
										<small id="emailHelp" class="form-text text-muted">Enter email address for login id. eg: abc@nic.com
						...
						<div class="row">
							<div class="col-sm">
									<div class="form-group">
										...
										<select class="form-control" name="bisdcode" id="exampleFormControlSelect2">
							...
							<div class="col-sm">
									<div class="form-group">
										...
										<input type="text" class="form-control" name="bphno" id="exampleInputReg1"  aria-describedby="regHelp"  placeholder="Enter your phone number" required>
										<!-- <small id="emailHelp" class="form-text text-muted">We'll never share your email with anyone else.</small> -->
									</div>
							</div>
						</div>
