...
<div class="header">
	...
	<br>
	<div align="right"><button type="button" class="btn btn-default btn-lg">
	...
	<h2>AVAILABLE TENDERS</h2></div><br>
			<table border="0" bgcolor="#f7f7f7" cellpadding="0" width="100%" cellspacing="1" id="table" class="list_table">
	          ...
	          <tr >
																		...
																		<td width="10%" class='tid'>??SERIAL.NO VARI??</td>																	        																												
       																	<td width="20%" align="center" class='tid'>??TENDER NO??</td> 
       																	<td width="40%" align="center" class='tid'>??LASTDATE VARI??</td> 
