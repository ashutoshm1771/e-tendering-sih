...
<div class="header">
	...
	<mapindia><img class="logo1" src="india2.png" alt="goi-logo"></mapindia>
      ...
      <h3  align="center">CREATE NEW PASSWORD</h3> 
                ...
                <div class="row">
                        <div class="col-sm">
                                 <div class="form-group" align="left">
                                     <h6>New Password*</h6><input type="text"  name="pass" id="exampleInputPoy1" aria-describedby="poyHelp"  placeholder="Eg:password@123" required>
                                     <h6>Reenter Password*</h6><input type="text"  name="pass" id="exampleInputPoy1" aria-describedby="poyHelp"  placeholder="re-enter password" required>
