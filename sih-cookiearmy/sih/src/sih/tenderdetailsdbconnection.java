...
public class tenderdetailsdbconnection {
	...
	public void inserttenderdetails(tenderdetailsrecord custRec) throws Exception
	{
	   ...
	   insertStatement += "INSERT INTO tenderdetails( tendertitle,referenceno,closingdate,biddingopeningdate,location,expectedcost,classification,publishcompany,tdetails,startdate,empid) VALUES ";
	   insertStatement += "(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public void updatetenderdetails(tenderdetailsrecord custRec) throws Exception
	{
	   ...
	   updateStatement += "UPDATE tenderdetails "
		...
		ps.setString(10, custRec.getEmpid());
		ps.setString(11, custRec.getReferenceno());
		ps.execute();
