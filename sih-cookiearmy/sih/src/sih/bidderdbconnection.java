...
public class bidderdbconnection {
	...
	public void updatebidder(bidderrecord custRec) throws Exception
	{
	   ...
	   updateStatement += "UPDATE bidder "
		...
		ps.setString(4, custRec.getBphno());
		ps.setString(5, custRec.getBemail());
		ps.setString(6, custRec.getBstate());
		ps.setString(7, custRec.getBdist());
		ps.setString(8, custRec.getBpincode());
		ps.setString(9, custRec.getBpass());
		ps.setString(10, custRec.getBidderid());
		ps.execute();
